...
class CRangeWord : public COleDispatchDriver
{
public:
	CRangeWord() {} // 调用 COleDispatchDriver 默认构造函数
	CRangeWord(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CRangeWord(const CRangeWord& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
