...
// CApplicationWord 包装器类

class CApplicationWord : public COleDispatchDriver
{
public:
	CApplicationWord() {} // 调用 COleDispatchDriver 默认构造函数
	CApplicationWord(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CApplicationWord(const CApplicationWord& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
